...
public class KitchenStaffInformation extends JFrame implements ActionListener {

    JTable t1;
    JButton b1, b2;

    KitchenStaffInformation() {
        ...
        JLabel l9 = new JLabel("KITCHEN STAFF INFORMATION");
        l9.setFont(new Font("Tahoma", Font.BOLD, 30));
        l9.setForeground(Color.YELLOW);
        l9.setBounds(450, 20, 500, 30);
        add(l9);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b1) {
            try {
                Conn c = new Conn();
                String str = "select * from add_employee where job = 'Kitchen Staff'";
