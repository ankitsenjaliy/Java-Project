...
public class WaiterAndWaitressInformation extends JFrame implements ActionListener {

    JTable t1;
    JButton b1, b2;

    WaiterAndWaitressInformation() {
        ...
        JLabel l9 = new JLabel("WAITER/WAITRESS INFORMATION");
        l9.setFont(new Font("Tahoma", Font.BOLD, 30));
        l9.setForeground(Color.RED);
        l9.setBounds(450, 20, 550, 30);
        add(l9);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b1) {
            try {
                Conn c = new Conn();
                String str = "select * from add_employee where job = 'Waiter/Waitress'";
    ...
    public static void main(String[] args) {
        new WaiterAndWaitressInformation();
    }
