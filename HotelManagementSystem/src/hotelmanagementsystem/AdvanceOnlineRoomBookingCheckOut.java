...
public class AdvanceOnlineRoomBookingCheckOut extends JFrame implements ActionListener {

    Choice c1;
    JTextField t1;
    JButton b1, b2, b3;

    AdvanceOnlineRoomBookingCheckOut() {
        ...
        if (ae.getSource() == b1) {
            ...
            if (room_no.length() == 0) {
                ...
                try {
                    ...
                    String str2 = "delete from new_registration_form_2 where id_card_no = '" + id_card_no + "'";
                    c.s.executeUpdate(str2);

                    
                    String str3 = "update add_room set availability = 'Available' where room_no = '" + room_no + "'";
    ...
    public static void main(String[] args) {
        new AdvanceOnlineRoomBookingCheckOut();
    }
}
