...
public class StudentAttendancePage extends JFrame implements ActionListener {
    ...
    StudentAttendancePage(String enrollment_id_no) {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("universitymanagementsystem/icons/U12.jpg"));
        Image i5 = i4.getImage().getScaledInstance(860, 600, Image.SCALE_DEFAULT);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == b1) {
            ...
            try {
                ...
                new StudentAttendance(enrollment_id_no).setVisible(true);
                this.setVisible(false);
