...
public class AddReturnBook extends JFrame implements ActionListener {

    JLabel l3, l4, l5, l6, l7, l8, l9, l10, l11, l12, l13, l14, l15, l16, l17, l18, l19, l20, l21, l22, l23, l24, l25, l26, l27, l28, l29, l30, l31;
    JTextField t1, t2;
    JComboBox C1;
    JButton b1, b2, b3, b4;
    ...
    AddReturnBook() {
        ...
        l3.setBounds(850, 150, 300, 30);
        add(l3);

        l4 = new JLabel();
        l4.setFont(new Font("Times New Roman", Font.PLAIN, 22));
        l4.setForeground(Color.CYAN);
        l4.setBounds(1200, 150, 600, 30);
        add(l4);
        ...
        l24.setBounds(1200, 450, 1000, 30);
        add(l24);
        ...
        l32.setBounds(0, 0, 1600, 750);
        add(l32);

        JLabel l33 = new JLabel("ADD RETURN BOOK");
        l33.setFont(new Font("Times New Roman", Font.BOLD, 40));
        l33.setForeground(Color.ORANGE);
        l33.setBounds(630, 20, 800, 50);
        l32.add(l33);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == b1) {
            ...
            new ReturnBookInformation().setVisible(true);
            ...
            String book_name = l4.getText();
            String author_name = l6.getText();
            String publisher_name = l8.getText();
            String isb_no = l10.getText();
            String book_price = l12.getText();
            String book_pages = l14.getText();

            String roll_no = l16.getText();
            String student_name = l18.getText();
            String father_name = l20.getText();
            String phone_no = l22.getText();
            String email_id = l24.getText();
            String course_name = l26.getText();
            String current_semester = l28.getText();

            String issue_book_date = l30.getText();

            String return_book_date = t2.getText();

            if (t2.getText().isEmpty()) {

                JOptionPane.showMessageDialog(null, "Please Enter Return Book Date", "ERROR", JOptionPane.ERROR_MESSAGE);
                ...
                try {
                    ...
                    String str5 = "insert into add_return_book values('" + enrollment_id_no + "','" + book_id_no + "','" + book_name + "','" + author_name + "','" + publisher_name + "','" + isb_no + "','" + book_price + "','" + book_pages + "','" + roll_no + "','" + student_name + "','" + father_name + "','" + phone_no + "','" + email_id + "','" + course_name + "','" + current_semester + "','" + issue_book_date + "','" + return_book_date + "')";
                    c.s.executeUpdate(str5);

                    String str6 = "delete from add_issue_book where book_id_no = '" + book_id_no + "' and enrollment_id_no = '" + enrollment_id_no + "'";
                    c.s.executeUpdate(str6);
                    

                    JOptionPane.showMessageDialog(null, "Return Book Added");
