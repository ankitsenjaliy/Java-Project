...
public class ChangePasswordFaculty extends JFrame implements ActionListener {
    ...
    ChangePasswordFaculty(String enrollment_id_no) {
        ...
        if (ae.getSource() == b1) {
            ...
            if ((t1.getText().isEmpty()) || check_phone_no(t1.getText())) {
                ...
                try {
                    ...
                    String str2 = "select * from add_new_faculty where enrollment_id_no = '" + enrollment_id_no + "' and phone_no = '" + phone_no + "' and password = '" + password + "'";
            ...
            if ((t3.getText().isEmpty()) || check_new_password(t3.getText())) {
                ...
                if (new_password.equals(confirm_new_password)) {
                    ...
                    try {
                        ...
                        String str4 = "Update add_new_faculty set password = '" + new_password + "' where enrollment_id_no = '" + enrollment_id_no + "'";
