...
public class FacultyViewDetails extends JFrame implements ActionListener {
    ...
    FacultyViewDetails(String enrollment_id_no) {
        ...
        l36.setForeground(Color.YELLOW);
        ...
        l38.setForeground(Color.YELLOW);
        ...
        l42.setForeground(Color.YELLOW);
        ...
        JLabel l46 = new JLabel("VIEW FACULTY DETAILS");
        l46.setFont(new Font("Times New Roman", Font.BOLD, 40));
        l46.setForeground(Color.MAGENTA);
