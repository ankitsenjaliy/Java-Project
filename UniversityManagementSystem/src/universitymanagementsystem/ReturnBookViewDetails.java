...
public class ReturnBookViewDetails extends JFrame implements ActionListener {

    JLabel l3, l4, l5, l6, l7, l8, l9, l10, l11, l12, l13, l14, l15, l16, l17, l18, l19, l20, l21, l22, l23, l24, l25, l26, l27, l28, l29, l30, l31, l32;
    JTextField t1;
    JComboBox C1;
    JButton b1, b2, b3, b4;

    ReturnBookViewDetails() {
        ...
        try {
            ...
            String str1 = "select * from add_return_book";
        ...
        JLabel l33 = new JLabel(i3);
        l33.setBounds(0, 0, 1600, 750);
        add(l33);

        JLabel l34 = new JLabel("RETURN BOOK VIEW DETAILS");
        l34.setFont(new Font("Times New Roman", Font.BOLD, 40));
        l34.setForeground(Color.ORANGE);
        l34.setBounds(530, 20, 800, 50);
        l33.add(l34);
        ...
        if (ae.getSource() == b1) {
            ...
            if ((t1.getText().isEmpty()) || check_book_id_no(t1.getText())) {
                ...
                try {
                    ...
                    String str2 = "select * from add_return_book where enrollment_id_no = '" + enrollment_id_no + "' and book_id_no = '" + book_id_no + "'";
                    ...
                    if (rs2.next()) {
                        ...
                        String return_book_date = rs2.getString("return_book_date");
