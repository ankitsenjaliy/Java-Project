...
public class FacultyInformation extends JFrame implements ActionListener {

    String x[] = {"Roll Number", "Enrollment Id Number", "Faculty Name", "Course Name", "Course Code"};
    ...
    FacultyInformation() {
        ...
        b1 = new JButton("ADD NEW FACULTY");
        ...
        b2 = new JButton("FACULTY DETAILS");
        ...
        b3 = new JButton("VIEW FACULTY DETAILS");
        ...
        b4 = new JButton("UPDATE FACULTY DETAILS");
        ...
        b5 = new JButton("DELETE FACULTY DETAILS");
        ...
        b6 = new JButton("FACULTY ADMISSION CANCEL");
        ...
        JLabel l1 = new JLabel("FACULTY INFORMATION");
        ...
        try {
            ...
            String str2 = "select count(*) from add_new_faculty";

            ResultSet rs2 = c.s.executeQuery(str2);

            rs2.next();

            int faculty = rs2.getInt(1);

            l2 = new JLabel("FACULTY = " + faculty);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == b1) {
            ...
            new AddNewFaculty1().setVisible(true);
            ...
            new FacultySearchDetails().setVisible(true);
            this.setVisible(false);

        } else if (ae.getSource() == b4) {

            new UpdateFacultyDetails().setVisible(true);
            this.setVisible(false);

        } else if (ae.getSource() == b5) {

            new FacultyDeleteDetails().setVisible(true);
            this.setVisible(false);

        } else if (ae.getSource() == b6) {

            new FacultyAdmissionCancelDetails().setVisible(true);
            this.setVisible(false);
