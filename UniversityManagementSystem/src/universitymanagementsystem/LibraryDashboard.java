...
public class LibraryDashboard extends JFrame implements ActionListener {
    ...
    LibraryDashboard() {
        ...
        b1 = new JButton("BOOK INFORMATION");
        b1.setFont(new Font("Times New Roman", Font.PLAIN, 20));
        b1.setBackground(Color.BLACK);
        b1.setForeground(Color.WHITE);
        b1.setMargin(new Insets(0, 0, 0, 70));
        b1.setBounds(0, 30, 300, 50);
        b1.addActionListener(this);
        p2.add(b1);

        b2 = new JButton("ISSUE BOOK INFORMATION");
        ...
        b3 = new JButton("RETURN BOOK INFORMATION");
        ...
        b4 = new JButton("STATISTICS DETAILS");
        ...
        b5 = new JButton("BUY BOOK INFORMATION");
        b5.setFont(new Font("Times New Roman", Font.PLAIN, 20));
        b5.setBackground(Color.BLACK);
        b5.setForeground(Color.WHITE);
        b5.setMargin(new Insets(0, 0, 0, 30));
        b5.setBounds(0, 230, 300, 50);
        b5.addActionListener(this);
        p2.add(b5);

        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("project/icons/L4.jpg"));
        Image i2 = i1.getImage().getScaledInstance(1650, 950, Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2);
        JLabel l1 = new JLabel(i3);
        l1.setBounds(300, 80, 1650, 950);
        add(l1);

        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("project/icons/L3.jpg"));
