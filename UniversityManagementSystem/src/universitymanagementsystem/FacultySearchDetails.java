...
public class FacultySearchDetails extends JFrame implements ActionListener {

    JTextField t1;
    JComboBox C1;
    JButton b1, b2;

    FacultySearchDetails() {
            ...
            if ((t1.getText().isEmpty()) || check_roll_no(t1.getText())) {
                ...
                try {
                    ...
                    if (rs2.next()) {
                        ...
                        FacultyViewDetails F = new FacultyViewDetails((String) C1.getSelectedItem());
