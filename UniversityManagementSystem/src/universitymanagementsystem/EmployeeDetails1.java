...
public class EmployeeDetails1 extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == b1) {
            ...
            try {
                ...
                String str1 = "select employee_name,gender,phone_no,employee_salary from add_new_employee where job_name = '" + c1.getSelectedItem() + "'";
