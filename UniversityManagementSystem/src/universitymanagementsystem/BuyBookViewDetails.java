...
public class BuyBookViewDetails extends JFrame implements ActionListener {
    ...
    BuyBookViewDetails() {
        ...
        l18.setBounds(1200, 400, 300, 30);
        add(l18);

        l19 = new JLabel("STUDENT NAME");
        ...
        l22.setBounds(1200, 450, 600, 30);
        add(l22);

        l23 = new JLabel("GENDER");
        ...
        l24.setBounds(450, 500, 600, 30);
        add(l24);

        l25 = new JLabel("PHONE NUMBER");
        ...
        l26.setBounds(1200, 500, 300, 30);
        add(l26);

        l27 = new JLabel("EMAIL ID");
        ...
        l28.setBounds(450, 550, 1000, 30);
        add(l28);

        l29 = new JLabel("COURSE NAME");
        ...
        l30.setBounds(1200, 550, 600, 30);
        add(l30);

        l31 = new JLabel("CURRENT SEMESTER");
        ...
        l32.setBounds(450, 600, 300, 30);
        add(l32);

        l33 = new JLabel("CURRENT YEAR");
        ...
        JLabel l39 = new JLabel(i3);
        l39.setBounds(0, 0, 1600, 850);
        add(l39);

        JLabel l40 = new JLabel("BUY BOOK VIEW DETAILS");
        l40.setFont(new Font("Times New Roman", Font.BOLD, 40));
        l40.setForeground(Color.ORANGE);
        l40.setBounds(530, 20, 800, 50);
        l39.add(l40);
        ...
        if (ae.getSource() == b1) {
            ...
            if ((t1.getText().isEmpty()) || check_book_id_no(t1.getText())) {
                ...
                try {
                    ...
                    String str2 = "select * from add_buy_book where enrollment_id_no = '" + enrollment_id_no + "' and book_id_no = '" + book_id_no + "'";
                    ...
                    if (rs2.next()) {
                        ...
                        String total_book = rs2.getString("total_book");
                        ...
                        String buy_total_book = rs2.getString("buy_total_book");
                        String total_payment = rs2.getString("total_payment");

                        l4.setText(book_name);
                        l6.setText(author_name);
                        l8.setText(publisher_name);
                        l10.setText(isb_no);
                        l12.setText(total_book);
                        l14.setText(book_price);
                        l16.setText(book_pages);
                        l18.setText(roll_no);
                        l20.setText(student_name);
                        l22.setText(father_name);
                        l24.setText(gender);
                        l26.setText(phone_no);
                        l28.setText(email_id);
                        l30.setText(course_name);
                        l32.setText(current_semester);
                        l34.setText(current_year);
                        l36.setText(buy_total_book);
                        l38.setText(total_payment);
