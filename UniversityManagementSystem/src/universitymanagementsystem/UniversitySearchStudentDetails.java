...
public class UniversitySearchStudentDetails extends JFrame implements ActionListener {

    JTextField t1;
    JComboBox C1;
    JButton b1, b2;

    UniversitySearchStudentDetails() {
            ...
            if ((t1.getText().isEmpty()) || check_roll_no(t1.getText())) {
                ...
                try {
                    ...
                    if (rs2.next()) {
                        ...
                        UniversityViewStudentDetails U = new UniversityViewStudentDetails((String) C1.getSelectedItem());
    ...
    public static void main(String[] args) {
        ...
        new UniversitySearchStudentDetails();
    }
}
