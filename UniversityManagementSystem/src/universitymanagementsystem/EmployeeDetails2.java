...
public class EmployeeDetails2 extends JFrame implements ActionListener {
    ...
    EmployeeDetails2() {
        ...
        JLabel l5 = new JLabel("ALTERNATE PHONE NUMBER");
        l5.setFont(new Font("Times New Roman", Font.PLAIN, 22));
        l5.setForeground(Color.BLUE);
        l5.setBounds(970, 130, 310, 30);
        add(l5);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == b1) {
            ...
            try {
                ...
                String str1 = "select employee_name,gender,phone_no,alternate_phone_no from add_new_employee where job_name = '" + c1.getSelectedItem() + "'";
