...
public class FeesStudentDetails extends JFrame implements ActionListener {
    ...
    FeesStudentDetails() {
        ...
        r1 = new JRadioButton("ONLY DISPLAY FEES STATUS YES");
        r1.setFont(new Font("Times New Roman", Font.PLAIN, 20));
        r1.setBackground(Color.YELLOW);
        r1.setForeground(Color.BLACK);
        r1.setBounds(900, 60, 340, 30);
        G.add(r1);
        add(r1);

        r2 = new JRadioButton("ONLY DISPLAY FEES STATUS NO");
        r2.setFont(new Font("Times New Roman", Font.PLAIN, 20));
        r2.setBackground(Color.YELLOW);
        r2.setForeground(Color.BLACK);
        r2.setBounds(900, 100, 340, 30);
        G.add(r2);
        add(r2);
        ...
        JLabel l6 = new JLabel("FEES STATUS");
        ...
        JLabel l7 = new JLabel("FEES DETAILS");
        l7.setFont(new Font("Times New Roman", Font.BOLD, 40));
        l7.setForeground(Color.RED);
        l7.setBounds(550, 20, 800, 50);
        add(l7);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == b1) {
            ...
            try {
                ...
                String str2 = "select roll_no,student_name,course_name,fees_status from student_fees where course_name = '" + C1.getSelectedItem() + "' and current_semester = '" + c1.getSelectedItem() + "'";

                String str3 = "select roll_no,student_name,course_name,fees_status from student_fees where fees_status = 'YES' and course_name = '" + C1.getSelectedItem() + "' and current_semester = '" + c1.getSelectedItem() + "'";

                String str4 = "select roll_no,student_name,course_name,fees_status from student_fees where fees_status = 'NO' and course_name = '" + C1.getSelectedItem() + "' and current_semester = '" + c1.getSelectedItem() + "'";
