...
public class StudentAndFacultyForgotEnrollmentNumber extends JFrame implements ActionListener {

    JComboBox C1;
    JTextField t1, t2;
    JButton b1, b2;

    StudentAndFacultyForgotEnrollmentNumber() {
        ...
        JLabel l2 = new JLabel("AADHAR CARD NUMBER");
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("project/icons/U3.jpg"));
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == b1) {
            ...
            String aadhar_card_no = t1.getText();
            String phone_no = t2.getText();

            String enrollment_id_no;

            if ((t1.getText().isEmpty()) || check_aadhar_card_no(t1.getText())) {
                ...
                if (user_account.equals("Student")) {
                    ...
                    try {
                        ...
                        String str1 = "select * from add_new_student_university where aadhar_card_no = '" + aadhar_card_no + "' and phone_no = '" + phone_no + "'";
                        ...
                        if (rs1.next()) {
                            ...
                            JOptionPane.showMessageDialog(null, "Show Enrollment Id Number" + "\n Enrollment Id Number = " + enrollment_id_no);
                            ...
                            JOptionPane.showMessageDialog(null, "Invalid Aadhar Card Number And Phone Number", "ERROR", JOptionPane.ERROR_MESSAGE);
                        }
                    ...
                    try {
                        ...
                        String str2 = "select * from add_new_faculty where aadhar_card_no = '" + aadhar_card_no + "' and phone_no = '" + phone_no + "'";

                        ResultSet rs2 = c.s.executeQuery(str2);

                        if (rs2.next()) {

                            enrollment_id_no = rs2.getString("enrollment_id_no");
    ...
    public static void main(String[] args) {
        ...
        new StudentAndFacultyForgotEnrollmentNumber();
    }
}
