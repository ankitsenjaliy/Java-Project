...
public class LibraryLogin extends JFrame implements ActionListener {
    ...
    LibraryLogin() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("project/icons/L1.jpg"));
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == b1) {
            ...
            if (user_name.length() == 0) {
                ...
                try {
                    ...
                    if (rs1.next()) {
                        ...
                        new LibraryLoading().setVisible(true);
            ...
            new LibraryForgotPassword().setVisible(true);
            this.setVisible(false);
