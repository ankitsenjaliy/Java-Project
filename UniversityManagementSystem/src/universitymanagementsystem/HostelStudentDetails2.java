...
public class HostelStudentDetails2 extends JFrame implements ActionListener {

    JTable t;
    JComboBox c1;
    JButton b1, b2;

    HostelStudentDetails2() {
        ...
        c1.setBounds(280, 70, 200, 30);
        add(c1);

        JLabel l2 = new JLabel("STUDENT NAME");
        l2.setFont(new Font("Times New Roman", Font.PLAIN, 22));
        l2.setForeground(Color.BLUE);
        l2.setBounds(80, 130, 300, 30);
        add(l2);
        ...
        l4.setBounds(720, 130, 300, 30);
        add(l4);

        JLabel l5 = new JLabel("FATHER NAME NUMBER");
        l5.setFont(new Font("Times New Roman", Font.PLAIN, 22));
        l5.setForeground(Color.BLUE);
        l5.setBounds(1000, 130, 300, 30);
        add(l5);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == b1) {
            ...
            try {
                ...
                String str1 = "select student_name,room_no,phone_no,father_phone_no from add_new_student_hostel where hostel_name = '" + c1.getSelectedItem() + "'";
