...
public class UniversityLogin extends JFrame implements ActionListener {
    ...
    UniversityLogin() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("project/icons/U5.jpg"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b1) {
            ...
            if (user_name.length() == 0) {
                ...
                try {
                    ...
                    if (rs1.next()) {
                        ...
                        new UniversityLoading().setVisible(true);
            ...
            new UniversityForgotPassword().setVisible(true);
            this.setVisible(false);
