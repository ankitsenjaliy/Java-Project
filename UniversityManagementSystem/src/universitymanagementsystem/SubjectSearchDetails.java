...
public class SubjectSearchDetails extends JFrame implements ActionListener {

    JTextField t1;
    JComboBox C1;
    JButton b1, b2;

    SubjectSearchDetails() {
        ...
        JLabel l2 = new JLabel("SUBJECT ID NUMBER");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == b1) {
            ...
            String subject_id_no = t1.getText();

            if (subject_id_no.length() == 0) {

                JOptionPane.showMessageDialog(null, "Please Enter Subject Id Number", "ERROR", JOptionPane.ERROR_MESSAGE);
                ...
                try {
                    ...
                    String str3 = "select * from add_new_subject where enrollment_id_no = '" + enrollment_id_no + "'  and subject_id_no = '" + subject_id_no + "'";

                    ResultSet rs3 = c.s.executeQuery(str3);

                    if (rs3.next()) {

                        SubjectViewDetails S = new SubjectViewDetails(t1.getText());
                        this.setVisible(false);

                    } else {

                        JOptionPane.showMessageDialog(null, "Invalid Subject Id Number", "ERROR", JOptionPane.ERROR_MESSAGE);
