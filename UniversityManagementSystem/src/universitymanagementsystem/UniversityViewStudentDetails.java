...
public class UniversityViewStudentDetails extends JFrame implements ActionListener {
    ...
    UniversityViewStudentDetails(String enrollment_id_no) {
        ...
        l43.setForeground(Color.YELLOW);
        ...
        l45.setForeground(Color.YELLOW);
        ...
        JLabel l48 = new JLabel("VIEW STUDENT DETAILS");
        l48.setFont(new Font("Times New Roman", Font.BOLD, 40));
        l48.setForeground(Color.MAGENTA);
    ...
    UniversityViewStudentDetails(String string, String text) {
    ...
    public static void main(String[] args) {
        ...
        new UniversityViewStudentDetails("");
    }
