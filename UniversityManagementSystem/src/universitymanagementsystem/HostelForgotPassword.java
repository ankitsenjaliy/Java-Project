...
public class HostelForgotPassword extends JFrame implements ActionListener {
    ...
    HostelForgotPassword() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("project/icons/H2.jpg"));
